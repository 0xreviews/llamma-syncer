...
import type { Llamma, LlammaInterface } from "../Llamma";
...
export class Llamma__factory {
  static readonly abi = _abi;
  static createInterface(): LlammaInterface {
    return new Interface(_abi) as LlammaInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Llamma {
    return new Contract(address, _abi, runner) as unknown as Llamma;
  }
}
