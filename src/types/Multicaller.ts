...
export interface MulticallerInterface extends Interface {
...
export interface Multicaller extends BaseContract {
  connect(runner?: ContractRunner | null): Multicaller;
  ...
  aggregate: TypedContractMethod<
    [targets: AddressLike[], data: BytesLike[], values: BigNumberish[]],
    [string[]],
    "payable"
  >;
